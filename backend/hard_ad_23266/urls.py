"""hard_ad_23266 URL Configuration
...
admin.site.site_header = "Hard ad"
admin.site.site_title = "Hard ad Admin Portal"
admin.site.index_title = "Hard ad Admin"

# swagger
api_info = openapi.Info(
    title="Hard ad API",
    default_version="v1",
    description="API documentation for Hard ad App",
)
